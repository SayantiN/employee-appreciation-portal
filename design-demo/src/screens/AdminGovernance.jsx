...
import { api, ApiError, download, exportUrl } from '../api/client.js';
  ...
  return (
    <div className="page fade-in">
      <div className="toolbar-row">
        ...
        <Button size="sm" onClick={() => { download('/api/admin/analytics/participation.csv'); }}>Export participation</Button>
      </div>
  ...
  return (
    <div className="page fade-in">
      <div className="toolbar-row">
        ...
        <Button size="sm" variant="primary" onClick={() => { download(exportUrl('/admin/audit.csv', last.current)); }}>Export CSV</Button>
      </div>
